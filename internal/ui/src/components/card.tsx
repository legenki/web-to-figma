...
function Card({
  ...
  return (
    <div
      className={cn(
        "corner-squircle neu-raised group/card flex flex-col gap-4 overflow-hidden rounded-xl border py-4 text-card-foreground text-sm shadow-sm [--neu-base:var(--card)] has-[>img:first-child]:pt-0 has-data-[slot=card-footer]:pb-0 data-[size=sm]:gap-3 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 supports-corner:rounded-[2.5rem] *:[img:first-child]:rounded-t-xl *:[img:last-child]:rounded-b-xl",
        className
      )}
      data-size={size}
      data-slot="card"
